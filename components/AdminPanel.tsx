    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 space-y-8">
      ...
      <section>
        ...
        <div className="opacity-60 pointer-events-none filter blur-[1px]">
          <p className="text-xs text-slate-500 mb-2 font-bold">高级自定义 (暂不可用，请使用上方一键生成)</p>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-500 mb-1">自定义楼栋数</label>
              <input type="number" value={config.buildingCount} disabled className="w-full border rounded px-3 py-2 text-sm bg-gray-50" />
            </div>
